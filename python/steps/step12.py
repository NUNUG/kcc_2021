###############################################################################
# Gobbler Step 12 - Music
###############################################################################
# There is no music in our game yet.  Music makes a huge difference and
# really completes the game!  We have two background musics to play.
# - A calm background tune to play during normal game play.
# - A more intense background tune to play while a power pellet is active.
###############################################################################
