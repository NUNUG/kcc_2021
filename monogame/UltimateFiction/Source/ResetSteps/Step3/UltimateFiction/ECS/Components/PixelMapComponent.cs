...
{
	public class PixelMapComponent : VisibleComponent
	{
		...
		public PixelMapComponent LoadTileMap(GameContent gameContent, string tilemapName)
		{
			TileSheetImages = new List<Texture2D>();
			TileSetIndexes = new List<int>();

			Depth = 0;
			Map = gameContent.TileMaps[tilemapName].Map;
